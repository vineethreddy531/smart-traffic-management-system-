class TrafficSignalController:
    def __init__(self):
        self.green_time = 100  # Initial green time in seconds
        self.red_time = 50    # Initial red time in seconds
        self.yellow_time = 5  # Initial yellow time in seconds
        self.max_green_time = 180  # Maximum green time
        self.min_green_time = 45  # Minimum green time
        self.max_red_time = 100    # Maximum red time
        self.min_red_time = 50    # Minimum red time
